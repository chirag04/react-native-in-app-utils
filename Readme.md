...
| introductoryPrice  | ?object (only iOS 11.2+) | Object with details of a discount for a subscription product. (see more [SKProductDiscount](https://developer.apple.com/documentation/storekit/skproductdiscount))                         |
