...
| subscriptionPeriod | ?object (only iOS 11.2+) | An object containing the subscription period duration information. (see more [SKProductSubscriptionPeriod](https://developer.apple.com/documentation/storekit/skproductsubscriptionperiod))    |
| introductoryPrice  | ?object (only iOS 11.2+) | Object with details of a discount for a subscription product. Excluding the "priceLocale" (see more [SKProductDiscount](https://developer.apple.com/documentation/storekit/skproductdiscount)) |
